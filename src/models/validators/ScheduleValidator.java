...
public class ScheduleValidator {
    public static List<String> validate(Schedule s){
        ...
        String monday1_error = _validateMonday1(s.getMonday1());
        if(!monday1_error.equals("")){
            errors.add(monday1_error);
        }

        String monday2_error = _validateMonday2(s.getMonday2());
        if(!monday2_error.equals("")){
            errors.add(monday2_error);
        }

        String tuesday1_error = _validateTuesday1(s.getTuesday1());
        if(!tuesday1_error.equals("")){
            errors.add(tuesday1_error);
        }

        String tuesday2_error = _validateTuesday2(s.getTuesday2());
        if(!tuesday2_error.equals("")){
            errors.add(tuesday2_error);
        }

        String wednesday1_error = _validateWednesday1(s.getWednesday1());
        if(!wednesday1_error.equals("")){
            errors.add(wednesday1_error);
        }

        String wednesday2_error = _validateWednesday2(s.getWednesday2());
        if(!wednesday2_error.equals("")){
            errors.add(wednesday2_error);
        }

        String thursday1_error = _validateThursday1(s.getThursday1());
        if(!thursday1_error.equals("")){
            errors.add(thursday1_error);
        }

        String thursday2_error = _validateThursday2(s.getThursday2());
        if(!thursday2_error.equals("")){
            errors.add(thursday2_error);
        }

        String friday1_error = _validateFriday1(s.getFriday1());
        if(!friday1_error.equals("")){
            errors.add(friday1_error);
        }

        String friday2_error = _validateFriday2(s.getFriday2());
        if(!friday2_error.equals("")){
            errors.add(friday2_error);
        }

        String saturday1_error = _validateSaturday1(s.getSaturday1());
        if(!saturday1_error.equals("")){
            errors.add(saturday1_error);
        }

        String saturday2_error = _validateSaturday2(s.getSaturday2());
        if(!saturday2_error.equals("")){
            errors.add(saturday2_error);
        }

        String sunday1_error = _validateSunday1(s.getSunday1());
        if(!sunday1_error.equals("")){
            errors.add(sunday1_error);
        }

        String sunday2_error = _validateSunday2(s.getSunday2());

...
/**
 * Servlet implementation class Schedule_dateIndexServlet
 */
@WebServlet("/schedule_date/index")
public class Schedule_dateIndexServlet extends HttpServlet {
    private static final long serialVersionUID = 1L;

    /**
     * @see HttpServlet#HttpServlet()
     */
    public Schedule_dateIndexServlet() {
        super();
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        RequestDispatcher rd = request.getRequestDispatcher("/WEB-INF/views/schedule_dates/index.jsp");
